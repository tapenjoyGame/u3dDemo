namespace LuaDLL
{
	...
	public partial class Lua
	{
        ...
        public static uint lua_objlen(IntPtr L, int stackPos)
        {
            return xlua_objlen(L, stackPos);
        }
#else

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern uint lua_objlen(IntPtr L, int stackPos);
#endif
        ...
        public static void lua_getglobal(IntPtr L, string name)//[-1, +0, m]
        {
            lua_pushstring(L, name);
            lua_rawget(L, LuaIndexes.LUA_GLOBALSINDEX);
        }
		...
		[DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		public static extern void lua_rawgeti(IntPtr L, int tableIndex, int index);

		[DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		public static extern void lua_rawseti(IntPtr L, int tableIndex, int index);//[-1, +0, m]

        public static void lua_getref(IntPtr L, int reference)
		{
			lua_rawgeti(L,LuaIndexes.LUA_REGISTRYINDEX,reference);
		}
...
#if LUA_53
        [DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		public static extern int xlua_pcall(IntPtr L, int nArgs, int nResults, int errfunc);
        public static int lua_pcall(IntPtr L, int nArgs, int nResults, int errfunc)
        {
            return xlua_pcall(L, nArgs, nResults, errfunc);
        }
#else
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
...
#if LUA_53
		[DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		public static extern double xlua_tonumber(IntPtr L, int index);
        public static double lua_tonumber(IntPtr L, int index)
        {
            return xlua_tonumber(L, index);
        }
#else
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        ...
        {
            return Convert.ToInt32(lua_tonumber(L, idx));
        }
        ...
        public static void lua_pushstring(IntPtr L, string str)
        {
            ...
            else
            {
                ...
                lua_pushlstring(L, bytes, bytes.Length);
            }
        }

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void lua_pushlstring(IntPtr L, byte[] str, int size);
...
#if LUA_53
        [DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		public static extern int xlua_loadbuffer(IntPtr L, byte[] buff, int size, string name);
        public static int luaL_loadbuffer(IntPtr L, byte[] buff, int size, string name)
        {
            return xlua_loadbuffer(L, buff, size, name);
        }
#else
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaL_loadbuffer(IntPtr L, byte[] buff, int size, string name);
#endif
        public static int luaL_loadbuffer(IntPtr L, string buff, string name)//[-0, +1, m]
        {
            byte[] bytes = Encoding.UTF8.GetBytes(buff);
            return luaL_loadbuffer(L, bytes, bytes.Length, name);
        }
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]//[,,m]
        public static extern int load_error_func(IntPtr L);
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void reg_profiler_set_hook(IntPtr L);
